...
import CarmonaslLoanCarmonaslLoanLoan from './carmonasl/loan/carmonasl.loan.loan'
...
export default { 
  CarmonaslLoanCarmonaslLoanLoan: load(CarmonaslLoanCarmonaslLoanLoan, 'carmonasl.loan.loan'),
